...
class CreateAbonadosProdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('abonados_prods', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_abonados_hrs');
            $table->double('total_abonados_coste_unit', 8, 2);
            $table->double('total_abonados_coste_total', 8, 2);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('abonados_prods');
    }
}
