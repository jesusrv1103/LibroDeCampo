...
class CreateCapturasTrampasProdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('captura_trampas_prods', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_captura_trampas_hrs');
            $table->double('total_captura_trampas_coste_unit', 8, 2);
            $table->double('total_captura_trampas_coste_total', 8, 2);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('capturas_trampas_prods');
    }
}
