...
class CreateControlPlagasProdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('control_plagas_prods', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_control_plagas_hrs');
            $table->double('total_control_plagas_coste_unit', 8, 2);
            $table->double('total_control_plagas_coste_total', 8, 2);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('control_plagas_prods');
    }
}
