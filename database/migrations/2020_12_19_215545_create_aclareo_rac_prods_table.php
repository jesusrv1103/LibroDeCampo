...
class CreateAclareoRacProdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aclareo_rac_prods', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_aclareos_hrs');
            $table->double('total_aclareos_coste_unit', 8, 2);
            $table->double('total_aclareos_coste_total', 8, 2);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('aclareo_rac_prods');
    }
}
