...
class CreateSeguimientoPlagasProdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('seguimiento_plagas_prods', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_seguimiento_plagas_hrs');
            $table->double('total_seguimiento_plagas_coste_unit', 8, 2);
            $table->double('total_seguimiento_plagas_coste_total', 8, 2);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('seguimiento_plagas_prods');
    }
}
