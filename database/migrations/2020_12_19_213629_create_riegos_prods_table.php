...
class CreateRiegosProdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('riegos_prods', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_riegos_hrs');
            $table->double('total_riegos_coste_unit', 8, 2);
            $table->double('total_riegos_coste_total', 8, 2);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('riegos_prods');
    }
}
