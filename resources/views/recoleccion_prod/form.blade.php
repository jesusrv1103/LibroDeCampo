...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('recoleccion_prod_save'))
        <div class="alert alert-success">
          {{ session('recoleccion_prod_save') }}
        </div>
      @endif

      <div class="card">
        <form action="{{ url('/recoleccion_prod_save')}}" method="POST">
          @csrf

          <div class="card-header text-center">AGREGAR RECOLECCIÓN DE COSTES DE PRODUCCIÓN</div>
          <div class="card-body">
