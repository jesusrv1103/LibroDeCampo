...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('aclareo_racimos_save'))
        <div class="alert alert-success">
          {{ session('aclareo_racimos_save') }}
        </div>
      @endif

      <img class="pictures_form" src="{{ asset('/pictures/AclareoRacimos.png') }}"/>
      <div class="card">
        <form action="{{ url('/aclareo_racimos_save')}}" method="POST">
          @csrf

          <div class="card-header text-center">AGREGAR ACLAREO RACIMOS</div>
          <div class="card-body">
            ...
            <div class="row form-group">
              <button type="submit" class="btn btn-success
                col-md-9 offset-2">Guardar</button>
            </div>
          </div>
        </form>
      </div>
