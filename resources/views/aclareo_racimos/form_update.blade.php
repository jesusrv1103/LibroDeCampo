...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('aclareo_racimos_update'))
        <div class="alert alert-success">
          {{ session('aclareo_racimos_update') }}
        </div>
      @endif
      ...
      <div class="card">
        <form action="{{ route('aclareo_racimos_update', $aclareo_racimo->id)}}"
          ...
          <div class="card-header text-center">MODIFICAR ACLAREO RACIMOS</div>
          <div class="card-body">
            <div class="row form-group">
              ...
              @foreach($parcelas as $parcela)
                <option value="{{ $parcela->id }}"
                    @if($parcela->id == $aclareo_racimo->parcela_id)
                      selected
                    @endif>
                  {{ $parcela->id }}
                </option>
            ...
            <div class="row form-group">
              ...
              <input type="date" name="fecha" value="{{ $aclareo_racimo->fecha}}"
            ...
            <div class="row form-group">
              ...
              <input type="text" name="practica_realizada"
                value="{{ $aclareo_racimo->practica_realizada}}"
                class="form-control col-md-7"/>
            </div>
...
<a class="btn btn-light btn-xs mt-5" href="{{url('/aclareo_racimos')}}">&laquo volver</a>
</div>
