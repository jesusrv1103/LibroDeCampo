...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('podas_prod_save'))
        <div class="alert alert-success">
          {{ session('podas_prod_save') }}
        </div>
      @endif

      <div class="card">
        <form action="{{ url('/podas_prod_save')}}" method="POST">
          @csrf

          <div class="card-header text-center">AGREGAR PODA DE COSTES DE PRODUCCIÓN</div>
          <div class="card-body">
            ...
            <div class="row form-group">
              <label for="" class="col-4">Coste Total</label>
              <input type="number" name="total_podas_coste_total"
                    class="form-control col-md-7"/>
            </div>
