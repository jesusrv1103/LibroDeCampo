...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('aclareo_racimos_prod_save'))
        <div class="alert alert-success">
          {{ session('aclareo_racimos_prod_save') }}
        </div>
      @endif

      <div class="card">
        <form action="{{ url('/aclareo_racimos_prod_save')}}" method="POST">
          @csrf

          <div class="card-header text-center">AGREGAR ACLAREO RACIMOS DE COSTES DE PRODUCCIÓN</div>
          <div class="card-body">
