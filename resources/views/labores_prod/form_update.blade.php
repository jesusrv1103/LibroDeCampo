...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('labores_prod_update'))
        <div class="alert alert-success">
          {{ session('labores_prod_update') }}
        </div>
      @endif

      <div class="card">
        <form action="{{ route('labores_prod_update', $labor_prod->id)}}" method="POST">
          @csrf @method('PATCH')

          <div class="card-header text-center">MODIFICAR LABOR DE COSTES DE PRODUCCIÓN</div>
          <div class="card-body">
            <div class="row form-group">
              ...
              @foreach($parcelas as $parcela)
                <option value="{{ $parcela->id }}"
                    @if($parcela->id == $labor_prod->parcela_id)
                      selected
                    @endif>
                  {{ $parcela->id }}
                </option>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_humanos_hrs"
                ...
                value="{{ $labor_prod->recursos_humanos_hrs }}"
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_humanos_coste_unit"
                class="form-control col-md-7"
                value="{{ $labor_prod->recursos_humanos_coste_unit }}"
                placeholder="Mano de obra; peón, experto,..."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_humanos_coste_total"
                class="form-control col-md-7"
                value="{{ $labor_prod->recursos_humanos_coste_total }}"
                placeholder="Mano de obra; peón, experto,..."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_materiales_hrs"
                class="form-control col-md-7"
                value="{{ $labor_prod->recursos_materiales_hrs }}"
            ...
            <div class="row form-group">
              ...
              <input type="number" name="resursos_materiales_coste_u"
                class="form-control col-md-7"
                value="{{ $labor_prod->resursos_materiales_coste_u }}"
                placeholder="Maquinaria, combustible, etc."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="resursos_materiales_coste_t"
                class="form-control col-md-7"
                value="{{ $labor_prod->resursos_materiales_coste_t }}"
                placeholder="Maquinaria, combustible, etc."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="total_labores_hrs"
                class="form-control col-md-7"
                value="{{ $labor_prod->total_labores_hrs }}"/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="total_labores_coste_unit"
                class="form-control col-md-7"
                value="{{ $labor_prod->total_labores_coste_unit }}"/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="total_labores_coste_total"
                class="form-control col-md-7"
                value="{{ $labor_prod->total_labores_coste_total }}"/>
            </div>
