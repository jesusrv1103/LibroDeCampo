...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7 mt-3">
      ...
      <!-- Mensaje de guardado -->
      @if(session('danos_fenom_meteors_prod_update'))
        <div class="alert alert-success">
          {{ session('danos_fenom_meteors_prod_update') }}
        </div>
      @endif

      <div class="card">
        <form action="{{ route('danos_fenom_meteors_prod_update', $dano_fenom_meteor_prod->id)}}" method="POST">
          @csrf @method('PATCH')

          <div class="card-header text-center">MODIFICAR DAÑO POR FENÓMENOS METEOROLÓGICOS COSTES DE PRODUCCIÓN</div>
          <div class="card-body">
            <div class="row form-group">
              ...
              @foreach($parcelas as $parcela)
                <option value="{{ $parcela->id }}"
                    @if($parcela->id == $dano_fenom_meteor_prod->parcela_id)
                      selected
                    @endif>
                  {{ $parcela->id }}
                </option>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_humanos_hrs"
                ...
                value="{{ $dano_fenom_meteor_prod->recursos_humanos_hrs }}"
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_humanos_coste_unit"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->recursos_humanos_coste_unit }}"
                placeholder="Mano de obra; peón, experto,..."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_humanos_coste_total"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->recursos_humanos_coste_total }}"
                placeholder="Mano de obra; peón, experto,..."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="recursos_materiales_hrs"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->recursos_materiales_hrs }}"
            ...
            <div class="row form-group">
              ...
              <input type="number" name="resursos_materiales_coste_u"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->resursos_materiales_coste_u }}"
                placeholder="Combustible, etc."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="resursos_materiales_coste_t"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->resursos_materiales_coste_t }}"
                placeholder="Combustible, etc."/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="total_danos_fenom_meteors_hrs"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->total_danos_fenom_meteors_hrs }}"/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="total_danos_fenom_meteors_coste_unit"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->total_danos_fenom_meteors_coste_unit }}"/>
            </div>
            ...
            <div class="row form-group">
              ...
              <input type="number" name="total_danos_fenom_meteors_coste_total"
                class="form-control col-md-7"
                value="{{ $dano_fenom_meteor_prod->total_danos_fenom_meteors_coste_total }}"/>
            </div>
